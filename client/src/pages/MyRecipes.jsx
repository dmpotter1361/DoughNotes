...
export default function MyRecipes() {
  ...
  return (
    <div>
      ...
      {recipes.length > 0 && (
        <div className="card" style={{ marginTop: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
          <div>
            <h2 style={{ margin: 0 }}>📖 Cookbook</h2>
            <p className="muted" style={{ margin: '0.3rem 0 0' }}>Design a cover and download all your recipes as one book.</p>
          </div>
          <Link to="/cookbook" className="btn">Create / edit cookbook →</Link>
        </div>
      )}
